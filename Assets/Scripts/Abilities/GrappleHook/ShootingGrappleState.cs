...
//         public void execute()
//         {
//             if (Input.GetMouseButton(1) && rb.linearVelocity.magnitude <= owner.terminalHookVelocity)
//             {
...
//         {
//             CameraControllerDEFUNCT cameraControllerDefunct = owner.player.transform.GetChild(1).GetComponent<CameraControllerDEFUNCT>();
//             return cameraControllerDefunct.transform.forward;
//         }
//     }
// }